  ...
  return (
    <div className='flex flex-col w-full px-6 max-w-[1536px] justify-center mt-2 mx-auto'>
      ...
      <div className='flex flex-col md:flex-row w-full items-center justify-center gap-8 mt-4'>
        ...
        <div className='p-6 rounded-lg font-semibold flex flex-col justify-center gap-3 md:gap-7 shadow-md w-full max-w-[400px] h-fit md:h-[300px] text-sm sm:text-lg md:text-xl text-green-700'> {/* recipe summary container */}
